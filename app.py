...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Nghiệp - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 094 9636 931</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Nghiệp - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 094 9636 931</div>", unsafe_allow_html=True)
